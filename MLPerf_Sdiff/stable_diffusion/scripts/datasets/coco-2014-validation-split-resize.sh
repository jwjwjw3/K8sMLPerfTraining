...
: "${INPUT_IMAGES_PATH:=./coco2014/val2014}"
: "${INPUT_COCO_CAPTIONS:=./coco2014/annotations/captions_val2014.json}"
: "${OUTPUT_IMAGES_PATH:=./coco2014/val2014_30k}"
: "${OUTPUT_TSV_FILE:=./coco2014/val2014_30k.tsv}"
: "${NUM_SAMPLES:=30000}"
