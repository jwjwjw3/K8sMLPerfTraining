...
if __name__ == "__main__":
  download_dataset("./igb_small_homo", 'homogeneous', 'small')
  download_dataset("./igb_small_hetero", 'heterogeneous', 'small')
  download_dataset("./igb_medium_homo", 'homogeneous', 'medium')
  download_dataset("./igb_medium_hetero", 'heterogeneous', 'medium')