...
if __name__ == '__main__':
  ...
  parser.add_argument('--train_batch_size', type=int, default=102)
  parser.add_argument('--val_batch_size', type=int, default=102)
  ...
  # run_training_proc(0, world_size, args.hidden_channels, args.num_classes, args.num_layers, 
  #         args.model, args.num_heads, args.fan_out, args.epochs, 
  #         args.train_batch_size, args.val_batch_size,
  #         args.learning_rate, args.random_seed,
  #         glt_dataset, train_idx, val_idx, args.with_gpu,
